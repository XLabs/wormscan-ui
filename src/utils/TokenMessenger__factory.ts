/* https://github.com/wormhole-foundation/wormhole-connect/blob/development/sdk/src/abis/circle_abis/TokenMessenger__factory.ts */
...
export class TokenMessenger__factory {
